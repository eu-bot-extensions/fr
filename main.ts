/*！
 * @file /eu-bot-extensions/fr/main.ts
 * @brief EuRate microbit motors and sensors makecode library.
 *
 * @copyright	[EuRate](https://github.com/eu-bot-extensions/fr/blob/master/LICENSE), 2023
 ...
 */
//% weight=10 color=#DF6721 icon="\uf11b" block="Eu Rate library FR"
namespace eurate {
